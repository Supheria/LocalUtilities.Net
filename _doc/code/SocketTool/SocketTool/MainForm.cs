...
namespace SocketTool
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            Image initialImg = Image.FromFile("固定通信设备.ico");
            Image serverImg = Image.FromFile("云服务器.png");
            Image clientImg = Image.FromFile("客户端.png");
            Image groupImg = Image.FromFile("组.png");
            imageList.Images.Add(initialImg);
            imageList.Images.Add(serverImg);
            imageList.Images.Add(clientImg);
            imageList.Images.Add(groupImg);
            treeViewSocket.ImageList = imageList;
